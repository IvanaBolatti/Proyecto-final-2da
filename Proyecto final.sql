...
(SELECT a.nombre, a.apellido FROM autor a JOIN nacionalidad n on a.id_nacionalidad=n.id);
...
SELECT i.nombre, i.apellido, rango_edad(24) FROM ilustrador i;
SELECT edad(i.fecha_nacim) from ilustrador i;
